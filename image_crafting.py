...
patch = cv2.imread("./shrinked_images/google.jpg")
...
filename = f"./crafted_images/mercedes_random_positions/google_{patch_idx}_crafted.png"
...
patch = cv2.imread("./shrinked_images/facebook.jpg")
patch = cv2.resize(patch, (patch_size, patch_size))  # Ensure correct size
...
filename = f"./crafted_images/mercedes_except_one_position/google_{alt_patch_idx}_crafted.png"
cv2.imwrite(filename, canvas)
